...
export default function RegisterStaff() {
  ...
  const roleTypes = ["Office Staff", "Accountant"];
  ...
  const validateForm = () => {
    ...
    if (!formData.roleType) {
      newErrors.roleType = "Please select a role";
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="bg-gradient-to-r from-amber-600 to-orange-600 p-3 rounded-xl w-fit mx-auto mb-4">
            <Building2 className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900">Little Scholars Academy</h1>
          <p className="text-gray-600 mt-2">Staff Registration</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white py-2 rounded-lg font-semibold"
            >
        ...
        {/* Info Box */}
        <div className="mt-6 bg-white rounded-lg p-4 shadow border-l-4 border-amber-500">
